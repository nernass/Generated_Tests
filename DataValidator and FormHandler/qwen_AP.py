...
class TestIntegrationDataValidatorAndFormHandler:
    ...
    def test_partial_failure_validator_throws_exception(self, form_handler, data_validator):
        data_validator.validate_email = MagicMock(side_effect=Exception("Validation failed"))
        with pytest.raises(Exception) as excinfo:
            form_handler.submit_form("user@example.com", "password123")
