...
def test_partial_failure_handling():
    ...
    mock_calculator.calculate_final_price.side_effect = Exception("Calculation error")
...
def test_edge_case_zero_price():
    ...
    catalog.products["free_item"] = {"base_price": 0, "category": "misc"}
    
    price = catalog.get_product_price("free_item", apply_discount=True)
    assert price == 0  # Zero price should remain zero even after tax and discount